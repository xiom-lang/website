...
### `format(fmt, args...)`
Formats a string using `fmt` as a template with variadic arguments. The syntax of the format string follows AXIOM's standard format specifiers (e.g., `{}` for positional argument insertion).
