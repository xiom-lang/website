...
> Companion to AXIOM_Build_Strategy.md. Covers how the compiler gets built and
> verified across targets, and how users install AXIOM.
...
Neither justifies a branch. AXIOM's stdlib defines a `cfg`-style mechanism for
...
#### Path 3: WASM Compiler Playground (Tertiary — Unique to AXIOM)

**This is the genuinely differentiated distribution path.** The AXIOM compiler
...
The website's primary CTA should be the playground ("Try AXIOM in your
...
multiple OSes, "which AXIOM version is installed" becomes a real question.
Model: `axiomup` (equivalent to `rustup`, `nvm`). Design the distribution
...
| Version manager? | DEFERRED to Phase 3 (`axiomup`) |

---

*AXIOM Cross-Platform Build & Distribution — Version 1.0. Decisions made 2026-06-30.*
